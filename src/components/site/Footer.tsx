...
export default function Footer() {
  return (
    <footer className="relative bg-brand-navy text-brand-cream pt-24 pb-10 overflow-hidden">
      ...
      <div className="absolute -top-20 -left-20 w-[250px] h-[250px] sm:w-[350px] sm:h-[350px] lg:w-[500px] lg:h-[500px] bg-brand-gold/10 blob-2 blur-2xl sm:blur-3xl pointer-events-none" />
      <div className="absolute -bottom-20 -right-20 w-[250px] h-[250px] sm:w-[350px] sm:h-[350px] lg:w-[500px] lg:h-[500px] bg-brand-leafdeep/30 blob-3 blur-2xl sm:blur-3xl pointer-events-none" />
